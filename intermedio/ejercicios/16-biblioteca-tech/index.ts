...
const guide: Exercise16Guide = {
  ...
  checklist: ["Modela el dominio de libros con tipos e interfaces claras.","Crea datos de prueba realistas para Biblioteca tech.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa arrays tipados y map sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise16Guide): void {
