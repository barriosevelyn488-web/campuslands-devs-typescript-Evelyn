...
Vas a resolver un caso relacionado con libros: **Biblioteca tech**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Biblioteca tech.
...
```text
intermedio/ejercicios/16-biblioteca-tech/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/16-biblioteca-tech/resoluciones/juan-perez/index.ts
```
