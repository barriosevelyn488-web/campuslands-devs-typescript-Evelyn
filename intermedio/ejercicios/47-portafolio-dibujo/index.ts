...
const guide: Exercise47Guide = {
  id: 47,
  title: "Portafolio de dibujo",
  difficulty: 'intermedio',
  topic: "dibujo",
  focus: "fechas, estados, reportes y agrupacion de datos",
  concepts: ["clases","generics","encapsulamiento","servicios"] as const,
  checklist: ["Modela el dominio de dibujo con tipos e interfaces claras.","Crea datos de prueba realistas para Portafolio de dibujo.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa clases y generics sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise47Guide): void {
