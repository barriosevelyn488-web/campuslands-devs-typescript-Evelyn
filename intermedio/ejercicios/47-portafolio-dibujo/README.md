...
Vas a resolver un caso relacionado con dibujo: **Portafolio de dibujo**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Portafolio de dibujo.
...
```text
intermedio/ejercicios/47-portafolio-dibujo/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/47-portafolio-dibujo/resoluciones/juan-perez/index.ts
```
