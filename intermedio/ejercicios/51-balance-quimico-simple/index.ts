...
const guide: Exercise51Guide = {
  id: 51,
  title: "Balance quimico simple",
  ...
  checklist: ["Modela el dominio de formulas quimicas con tipos e interfaces claras.","Crea datos de prueba realistas para Balance quimico simple.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa async/await y Promise sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise51Guide): void {
