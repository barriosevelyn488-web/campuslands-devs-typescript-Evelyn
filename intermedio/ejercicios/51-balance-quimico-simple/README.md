...
Vas a resolver un caso relacionado con formulas quimicas: **Balance quimico simple**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de formulas quimicas con tipos e interfaces claras.
2. Crea datos de prueba realistas para Balance quimico simple.
...
```text
intermedio/ejercicios/51-balance-quimico-simple/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/51-balance-quimico-simple/resoluciones/juan-perez/index.ts
```
