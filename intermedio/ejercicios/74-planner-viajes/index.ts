...
const guide: Exercise74Guide = {
  id: 74,
  title: "Planner de viajes DOM",
  ...
  checklist: ["Modela el dominio de viajes con tipos e interfaces claras.","Crea datos de prueba realistas para Planner de viajes DOM.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa arquitectura simple y DTO sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise74Guide): void {
