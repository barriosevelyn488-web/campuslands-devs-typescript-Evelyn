...
Vas a resolver un caso relacionado con viajes: **Planner de viajes DOM**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Planner de viajes DOM.
...
```text
intermedio/ejercicios/74-planner-viajes/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/74-planner-viajes/resoluciones/juan-perez/index.ts
```
