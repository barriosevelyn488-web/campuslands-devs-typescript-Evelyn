...
Vas a resolver un caso relacionado con carreras: **Simulador de carrera por vueltas**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Simulador de carrera por vueltas.
...
```text
intermedio/ejercicios/11-circuito-carreras/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/11-circuito-carreras/resoluciones/juan-perez/index.ts
```
