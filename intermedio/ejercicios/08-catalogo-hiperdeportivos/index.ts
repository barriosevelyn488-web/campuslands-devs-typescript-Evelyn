...
const guide: Exercise08Guide = {
  id: 8,
  title: "Catalogo de hiperdeportivos",
  ...
  checklist: ["Modela el dominio de autos, autos de lujo y vehiculos hiperdeportivos con tipos e interfaces claras.","Crea datos de prueba realistas para Catalogo de hiperdeportivos.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa interface y type alias sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise08Guide): void {
