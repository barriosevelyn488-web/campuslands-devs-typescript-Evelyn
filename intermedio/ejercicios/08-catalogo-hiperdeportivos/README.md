# 08. Catalogo de hiperdeportivos
...
autos, autos de lujo y vehiculos hiperdeportivos

## Contexto del problema

Vas a resolver un caso relacionado con autos, autos de lujo y vehiculos hiperdeportivos: **Catalogo de hiperdeportivos**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de autos, autos de lujo y vehiculos hiperdeportivos con tipos e interfaces claras.
2. Crea datos de prueba realistas para Catalogo de hiperdeportivos.
3. Implementa funciones separadas para validar, transformar y calcular resultados.
4. Usa interface y type alias sin recurrir a any.
...
```text
intermedio/ejercicios/08-catalogo-hiperdeportivos/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/08-catalogo-hiperdeportivos/resoluciones/juan-perez/index.ts
```
...
Conceptos recomendados: `interface`, `type alias`, `readonly`, `funciones tipadas`.
