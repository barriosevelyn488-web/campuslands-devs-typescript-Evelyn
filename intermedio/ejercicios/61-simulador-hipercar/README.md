...
Vas a resolver un caso relacionado con autos, autos de lujo y vehiculos hiperdeportivos: **Simulador de aceleracion hypercar**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Simulador de aceleracion hypercar.
...
```text
intermedio/ejercicios/61-simulador-hipercar/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/61-simulador-hipercar/resoluciones/juan-perez/index.ts
```
