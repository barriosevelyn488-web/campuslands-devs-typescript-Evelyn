...
Vas a resolver un caso relacionado con tatuajes: **Booking tattoo app**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de tatuajes con tipos e interfaces claras.
2. Crea datos de prueba realistas para Booking tattoo app.
...
```text
intermedio/ejercicios/77-tattoo-booking-app/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/77-tattoo-booking-app/resoluciones/juan-perez/index.ts
```
