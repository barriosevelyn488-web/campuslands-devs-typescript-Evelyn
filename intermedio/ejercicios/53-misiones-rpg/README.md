...
Vas a resolver un caso relacionado con videojuegos RPG: **Gestor de misiones RPG**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de videojuegos RPG con tipos e interfaces claras.
2. Crea datos de prueba realistas para Gestor de misiones RPG.
...
```text
intermedio/ejercicios/53-misiones-rpg/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/53-misiones-rpg/resoluciones/juan-perez/index.ts
```
