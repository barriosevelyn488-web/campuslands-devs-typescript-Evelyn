...
const guide: Exercise53Guide = {
  id: 53,
  title: "Gestor de misiones RPG",
  ...
  checklist: ["Modela el dominio de videojuegos RPG con tipos e interfaces claras.","Crea datos de prueba realistas para Gestor de misiones RPG.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa async/await y Promise sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise53Guide): void {
