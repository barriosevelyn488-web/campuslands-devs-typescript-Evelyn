...
const guide: Exercise62Guide = {
  id: 62,
  title: "Dashboard multi-deporte",
  ...
  checklist: ["Modela el dominio de deportes con tipos e interfaces claras.","Crea datos de prueba realistas para Dashboard multi-deporte.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa discriminated unions y reducers sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise62Guide): void {
