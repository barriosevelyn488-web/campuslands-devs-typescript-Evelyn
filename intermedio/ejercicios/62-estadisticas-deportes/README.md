...
Vas a resolver un caso relacionado con deportes: **Dashboard multi-deporte**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de deportes con tipos e interfaces claras.
2. Crea datos de prueba realistas para Dashboard multi-deporte.
...
```text
intermedio/ejercicios/62-estadisticas-deportes/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/62-estadisticas-deportes/resoluciones/juan-perez/index.ts
```
