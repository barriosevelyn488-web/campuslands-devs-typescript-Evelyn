...
Vas a resolver un caso relacionado con peliculas: **Recomendador de streaming**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de peliculas con tipos e interfaces claras.
2. Crea datos de prueba realistas para Recomendador de streaming.
...
```text
intermedio/ejercicios/39-streaming-peliculas/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/39-streaming-peliculas/resoluciones/juan-perez/index.ts
```
