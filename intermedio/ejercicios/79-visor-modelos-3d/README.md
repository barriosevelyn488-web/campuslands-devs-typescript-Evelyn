...
Vas a resolver un caso relacionado con pingpong: **Visor de assets 3D**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Visor de assets 3D.
...
```text
intermedio/ejercicios/79-visor-modelos-3d/resoluciones/juan-perez/index.ts
```
