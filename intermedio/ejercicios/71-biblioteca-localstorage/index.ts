...
const guide: Exercise71Guide = {
  id: 71,
  title: "Biblioteca con localStorage",
  ...
  checklist: ["Modela el dominio de libros con tipos e interfaces claras.","Crea datos de prueba realistas para Biblioteca con localStorage.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa arquitectura simple y DTO sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise71Guide): void {
