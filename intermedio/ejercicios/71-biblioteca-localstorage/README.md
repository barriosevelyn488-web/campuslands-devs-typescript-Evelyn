...
Vas a resolver un caso relacionado con libros: **Biblioteca con localStorage**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de libros con tipos e interfaces claras.
2. Crea datos de prueba realistas para Biblioteca con localStorage.
...
```text
intermedio/ejercicios/71-biblioteca-localstorage/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/71-biblioteca-localstorage/resoluciones/juan-perez/index.ts
```
