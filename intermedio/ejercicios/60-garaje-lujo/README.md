...
Vas a resolver un caso relacionado con autos, autos de lujo y vehiculos hiperdeportivos: **Garaje de lujo**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Garaje de lujo.
...
```text
intermedio/ejercicios/60-garaje-lujo/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/60-garaje-lujo/resoluciones/juan-perez/index.ts
```
