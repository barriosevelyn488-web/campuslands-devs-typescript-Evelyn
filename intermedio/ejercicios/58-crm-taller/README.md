...
Vas a resolver un caso relacionado con motos y mecanica de motos: **Mini CRM de taller**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Mini CRM de taller.
...
```text
intermedio/ejercicios/58-crm-taller/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/58-crm-taller/resoluciones/juan-perez/index.ts
```
