...
Vas a resolver un caso relacionado con carreras: **Cronometro de vueltas**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Cronometro de vueltas.
...
```text
intermedio/ejercicios/66-cronometro-carreras/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/66-cronometro-carreras/resoluciones/juan-perez/index.ts
```
