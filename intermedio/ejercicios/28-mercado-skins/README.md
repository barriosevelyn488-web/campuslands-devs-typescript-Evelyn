...
Vas a resolver un caso relacionado con videojuegos shooters: **Mercado de skins**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Mercado de skins.
...
```text
intermedio/ejercicios/28-mercado-skins/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/28-mercado-skins/resoluciones/juan-perez/index.ts
```
