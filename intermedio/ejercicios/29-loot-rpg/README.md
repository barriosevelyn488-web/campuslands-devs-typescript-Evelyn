...
Vas a resolver un caso relacionado con videojuegos battle royale: **Sistema de loot RPG**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Sistema de loot RPG.
...
```text
intermedio/ejercicios/29-loot-rpg/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/29-loot-rpg/resoluciones/juan-perez/index.ts
```
