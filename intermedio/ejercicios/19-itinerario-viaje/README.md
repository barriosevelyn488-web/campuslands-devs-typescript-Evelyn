...
Vas a resolver un caso relacionado con viajes: **Itinerario de viaje**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Itinerario de viaje.
...
```text
intermedio/ejercicios/19-itinerario-viaje/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/19-itinerario-viaje/resoluciones/juan-perez/index.ts
```
