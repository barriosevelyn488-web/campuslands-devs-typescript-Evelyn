...
Vas a resolver un caso relacionado con turismo: **Comparador de turismo**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Comparador de turismo.
...
```text
intermedio/ejercicios/20-paquetes-turisticos/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/20-paquetes-turisticos/resoluciones/juan-perez/index.ts
```
