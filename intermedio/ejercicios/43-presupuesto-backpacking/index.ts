...
const guide: Exercise43Guide = {
  id: 43,
  title: "Presupuesto backpacking",
  difficulty: 'intermedio',
  topic: "viajes",
  focus: "fechas, estados, reportes y agrupacion de datos",
  concepts: ["clases","generics","encapsulamiento","servicios"] as const,
  checklist: ["Modela el dominio de viajes con tipos e interfaces claras.","Crea datos de prueba realistas para Presupuesto backpacking.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa clases y generics sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise43Guide): void {
