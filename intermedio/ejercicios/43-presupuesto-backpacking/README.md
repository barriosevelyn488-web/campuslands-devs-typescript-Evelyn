...
Vas a resolver un caso relacionado con viajes: **Presupuesto backpacking**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de viajes con tipos e interfaces claras.
2. Crea datos de prueba realistas para Presupuesto backpacking.
...
```text
intermedio/ejercicios/43-presupuesto-backpacking/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/43-presupuesto-backpacking/resoluciones/juan-perez/index.ts
```
