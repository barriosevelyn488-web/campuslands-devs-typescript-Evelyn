...
Vas a resolver un caso relacionado con comida: **Menu interactivo comida**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de comida con tipos e interfaces claras.
2. Crea datos de prueba realistas para Menu interactivo comida.
...
```text
intermedio/ejercicios/72-menu-comida-app/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/72-menu-comida-app/resoluciones/juan-perez/index.ts
```
