...
const guide: Exercise72Guide = {
  id: 72,
  title: "Menu interactivo comida",
  ...
  checklist: ["Modela el dominio de comida con tipos e interfaces claras.","Crea datos de prueba realistas para Menu interactivo comida.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa arquitectura simple y DTO sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise72Guide): void {
