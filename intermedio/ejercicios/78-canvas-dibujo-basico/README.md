...
Vas a resolver un caso relacionado con dibujo: **Canvas de dibujo basico**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de dibujo con tipos e interfaces claras.
2. Crea datos de prueba realistas para Canvas de dibujo basico.
...
```text
intermedio/ejercicios/78-canvas-dibujo-basico/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/78-canvas-dibujo-basico/resoluciones/juan-perez/index.ts
```
