...
const guide: Exercise78Guide = {
  id: 78,
  title: "Canvas de dibujo basico",
  ...
  checklist: ["Modela el dominio de dibujo con tipos e interfaces claras.","Crea datos de prueba realistas para Canvas de dibujo basico.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa arquitectura simple y DTO sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise78Guide): void {
