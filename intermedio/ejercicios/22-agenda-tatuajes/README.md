...
Vas a resolver un caso relacionado con tatuajes: **Agenda de tatuajes**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Agenda de tatuajes.
...
```text
intermedio/ejercicios/22-agenda-tatuajes/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/22-agenda-tatuajes/resoluciones/juan-perez/index.ts
```
