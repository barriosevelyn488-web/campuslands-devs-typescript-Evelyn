...
Vas a resolver un caso relacionado con videojuegos MOBA: **Rotacion de heroes MOBA**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de videojuegos MOBA con tipos e interfaces claras.
2. Crea datos de prueba realistas para Rotacion de heroes MOBA.
...
```text
intermedio/ejercicios/04-rotacion-moba/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/04-rotacion-moba/resoluciones/juan-perez/index.ts
```
