...
const guide: Exercise04Guide = {
  id: 4,
  title: "Rotacion de heroes MOBA",
  ...
  checklist: ["Modela el dominio de videojuegos MOBA con tipos e interfaces claras.","Crea datos de prueba realistas para Rotacion de heroes MOBA.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa interface y type alias sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise04Guide): void {
