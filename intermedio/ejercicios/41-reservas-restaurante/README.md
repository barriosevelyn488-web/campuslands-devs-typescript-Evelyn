...
Vas a resolver un caso relacionado con comida: **Reservas de restaurante**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Reservas de restaurante.
...
```text
intermedio/ejercicios/41-reservas-restaurante/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/41-reservas-restaurante/resoluciones/juan-perez/index.ts
```
