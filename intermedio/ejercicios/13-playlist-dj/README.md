...
Vas a resolver un caso relacionado con musica: **Curador de playlist**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Curador de playlist.
...
```text
intermedio/ejercicios/13-playlist-dj/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/13-playlist-dj/resoluciones/juan-perez/index.ts
```
