...
const guide: Exercise13Guide = {
  id: 13,
  title: "Curador de playlist",
  difficulty: 'intermedio',
  topic: "musica",
  focus: "objetos anidados, filtros, reduce y validaciones",
  concepts: ["arrays tipados","map","filter","sort"] as const,
  checklist: ["Modela el dominio de musica con tipos e interfaces claras.","Crea datos de prueba realistas para Curador de playlist.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa arrays tipados y map sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise13Guide): void {
