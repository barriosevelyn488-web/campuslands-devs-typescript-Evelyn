...
Vas a resolver un caso relacionado con autos, autos de lujo y vehiculos hiperdeportivos: **Subasta de autos de lujo**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Subasta de autos de lujo.
3. Implementa funciones separadas para validar, transformar y calcular resultados.
4. Usa union types y literal types sin recurrir a any.
...
```text
intermedio/ejercicios/34-subasta-autos-lujo/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/34-subasta-autos-lujo/resoluciones/juan-perez/index.ts
```
...
Conceptos recomendados: `union types`, `literal types`, `type guards`, `validacion`.
