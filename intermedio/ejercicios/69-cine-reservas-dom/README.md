...
Vas a resolver un caso relacionado con peliculas: **Reservas de cine DOM**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Reservas de cine DOM.
...
```text
intermedio/ejercicios/69-cine-reservas-dom/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/69-cine-reservas-dom/resoluciones/juan-perez/index.ts
```
