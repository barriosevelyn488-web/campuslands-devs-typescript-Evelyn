...
Vas a resolver un caso relacionado con kickboxing: **Bracket de kickboxing**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de kickboxing con tipos e interfaces claras.
2. Crea datos de prueba realistas para Bracket de kickboxing.
...
```text
intermedio/ejercicios/36-bracket-kickboxing/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/36-bracket-kickboxing/resoluciones/juan-perez/index.ts
```
