...
Vas a resolver un caso relacionado con musica: **Playlist interactiva**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Playlist interactiva.
...
```text
intermedio/ejercicios/68-reproductor-playlist/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/68-reproductor-playlist/resoluciones/juan-perez/index.ts
```
