...
Vas a resolver un caso relacionado con ropa: **Drop de ropa streetwear**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Drop de ropa streetwear.
...
```text
intermedio/ejercicios/18-drop-ropa-streetwear/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/18-drop-ropa-streetwear/resoluciones/juan-perez/index.ts
```
