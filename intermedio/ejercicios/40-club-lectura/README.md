...
Vas a resolver un caso relacionado con libros: **Club de lectura**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Club de lectura.
...
```text
intermedio/ejercicios/40-club-lectura/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/40-club-lectura/resoluciones/juan-perez/index.ts
```
