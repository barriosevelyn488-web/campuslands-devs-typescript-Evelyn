...
Vas a resolver un caso relacionado con comida: **Pedidos de food truck**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Pedidos de food truck.
...
```text
intermedio/ejercicios/17-pedidos-foodtruck/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/17-pedidos-foodtruck/resoluciones/juan-perez/index.ts
```
