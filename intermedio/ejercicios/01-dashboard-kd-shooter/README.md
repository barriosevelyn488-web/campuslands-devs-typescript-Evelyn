...
Vas a resolver un caso relacionado con videojuegos shooters: **Dashboard K/D de squad shooter**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Dashboard K/D de squad shooter.
...
```text
intermedio/ejercicios/01-dashboard-kd-shooter/resoluciones/nombre-apellido/
```
