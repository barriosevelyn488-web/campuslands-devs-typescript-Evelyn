...
Vas a resolver un caso relacionado con videojuegos MOBA: **Draft inteligente MOBA**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Draft inteligente MOBA.
...
```text
intermedio/ejercicios/30-draft-moba/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/30-draft-moba/resoluciones/juan-perez/index.ts
```
