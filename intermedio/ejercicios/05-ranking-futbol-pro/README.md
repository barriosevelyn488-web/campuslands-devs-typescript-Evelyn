# 05. Ranking de jugadores de futbol
...
Vas a resolver un caso relacionado con futbol: **Ranking de jugadores de futbol**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de futbol con tipos e interfaces claras.
2. Crea datos de prueba realistas para Ranking de jugadores de futbol.
...
```text
intermedio/ejercicios/05-ranking-futbol-pro/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/05-ranking-futbol-pro/resoluciones/juan-perez/index.ts
```
