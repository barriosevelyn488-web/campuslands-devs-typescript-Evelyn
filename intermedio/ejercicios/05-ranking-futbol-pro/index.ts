...
const guide: Exercise05Guide = {
  id: 5,
  title: "Ranking de jugadores de futbol",
  ...
  checklist: ["Modela el dominio de futbol con tipos e interfaces claras.","Crea datos de prueba realistas para Ranking de jugadores de futbol.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa interface y type alias sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise05Guide): void {
