...
Vas a resolver un caso relacionado con soldadura: **Control de soldadura**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Control de soldadura.
...
```text
intermedio/ejercicios/26-orden-soldadura/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/26-orden-soldadura/resoluciones/juan-perez/index.ts
```
