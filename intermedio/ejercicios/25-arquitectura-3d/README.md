...
Vas a resolver un caso relacionado con diseno 3D arquitectura: **Revision de renders arquitectura**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Revision de renders arquitectura.
...
```text
intermedio/ejercicios/25-arquitectura-3d/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/25-arquitectura-3d/resoluciones/juan-perez/index.ts
```
