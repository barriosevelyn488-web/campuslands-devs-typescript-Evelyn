...
Vas a resolver un caso relacionado con kickboxing: **Marcador de kickboxing**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Marcador de kickboxing.
...
```text
intermedio/ejercicios/10-marcador-kickboxing/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/10-marcador-kickboxing/resoluciones/juan-perez/index.ts
```
