...
const guide: Exercise32Guide = {
  id: 32,
  title: "Temporada modo carrera",
  ...
  checklist: ["Modela el dominio de futbol con tipos e interfaces claras.","Crea datos de prueba realistas para Temporada modo carrera.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa union types y literal types sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise32Guide): void {
