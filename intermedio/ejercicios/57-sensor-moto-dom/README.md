...
Vas a resolver un caso relacionado con motos y mecanica de motos: **Panel DOM de sensores moto**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Panel DOM de sensores moto.
...
```text
intermedio/ejercicios/57-sensor-moto-dom/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/57-sensor-moto-dom/resoluciones/juan-perez/index.ts
```
