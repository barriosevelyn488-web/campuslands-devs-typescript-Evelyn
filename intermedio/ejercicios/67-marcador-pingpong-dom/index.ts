...
const guide: Exercise67Guide = {
  id: 67,
  title: "Marcador pingpong DOM",
  ...
  checklist: ["Modela el dominio de pingpong con tipos e interfaces claras.","Crea datos de prueba realistas para Marcador pingpong DOM.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa discriminated unions y reducers sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise67Guide): void {
