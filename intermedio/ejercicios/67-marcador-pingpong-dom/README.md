...
Vas a resolver un caso relacionado con pingpong: **Marcador pingpong DOM**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Marcador pingpong DOM.
...
```text
intermedio/ejercicios/67-marcador-pingpong-dom/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/67-marcador-pingpong-dom/resoluciones/juan-perez/index.ts
```
