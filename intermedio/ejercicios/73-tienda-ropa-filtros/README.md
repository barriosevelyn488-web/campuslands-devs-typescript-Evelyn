...
Vas a resolver un caso relacionado con ropa: **Tienda de ropa con filtros**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de ropa con tipos e interfaces claras.
2. Crea datos de prueba realistas para Tienda de ropa con filtros.
...
```text
intermedio/ejercicios/73-tienda-ropa-filtros/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/73-tienda-ropa-filtros/resoluciones/juan-perez/index.ts
```
