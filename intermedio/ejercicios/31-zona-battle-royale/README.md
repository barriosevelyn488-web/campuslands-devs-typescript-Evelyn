...
Vas a resolver un caso relacionado con videojuegos battle royale: **Simulador de zona battle royale**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de videojuegos battle royale con tipos e interfaces claras.
2. Crea datos de prueba realistas para Simulador de zona battle royale.
...
```text
intermedio/ejercicios/31-zona-battle-royale/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/31-zona-battle-royale/resoluciones/juan-perez/index.ts
```
