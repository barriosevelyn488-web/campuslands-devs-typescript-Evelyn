...
Vas a resolver un caso relacionado con autos, autos de lujo y vehiculos hiperdeportivos: **Comparador de autos premium**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Comparador de autos premium.
3. Implementa funciones separadas para validar, transformar y calcular resultados.
4. Usa async/await y Promise sin recurrir a any.
...
```text
intermedio/ejercicios/59-comparador-autos/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/59-comparador-autos/resoluciones/juan-perez/index.ts
```
...
Conceptos recomendados: `async/await`, `Promise`, `try/catch`, `errores tipados`.
