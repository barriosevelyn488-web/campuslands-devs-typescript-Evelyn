...
Vas a resolver un caso relacionado con pingpong: **Ranking ELO pingpong**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de pingpong con tipos e interfaces claras.
2. Crea datos de prueba realistas para Ranking ELO pingpong.
...
```text
intermedio/ejercicios/37-ranking-pingpong-elo/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/37-ranking-pingpong-elo/resoluciones/juan-perez/index.ts
```
