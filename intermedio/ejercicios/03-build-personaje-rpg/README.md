...
Vas a resolver un caso relacionado con videojuegos RPG: **Builder de personaje RPG**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Builder de personaje RPG.
...
```text
intermedio/ejercicios/03-build-personaje-rpg/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/03-build-personaje-rpg/resoluciones/juan-perez/index.ts
```
