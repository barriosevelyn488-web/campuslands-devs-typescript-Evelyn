...
const guide: Exercise12Guide = {
  id: 12,
  title: "Liga de pingpong",
  difficulty: 'intermedio',
  topic: "pingpong",
  focus: "objetos anidados, filtros, reduce y validaciones",
  concepts: ["arrays tipados","map","filter","sort"] as const,
  checklist: ["Modela el dominio de pingpong con tipos e interfaces claras.","Crea datos de prueba realistas para Liga de pingpong.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa arrays tipados y map sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise12Guide): void {
