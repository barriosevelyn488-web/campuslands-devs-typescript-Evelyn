...
Vas a resolver un caso relacionado con pingpong: **Liga de pingpong**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Liga de pingpong.
...
```text
intermedio/ejercicios/12-liga-pingpong/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/12-liga-pingpong/resoluciones/juan-perez/index.ts
```
