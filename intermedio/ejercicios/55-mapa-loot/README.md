...
Vas a resolver un caso relacionado con videojuegos battle royale: **Mapa de loot battle royale**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Mapa de loot battle royale.
...
```text
intermedio/ejercicios/55-mapa-loot/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/55-mapa-loot/resoluciones/juan-perez/index.ts
```
