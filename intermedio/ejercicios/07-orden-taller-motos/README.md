...
motos y mecanica de motos

## Contexto del problema

Vas a resolver un caso relacionado con motos y mecanica de motos: **Ordenes de taller de motos**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de motos y mecanica de motos con tipos e interfaces claras.
2. Crea datos de prueba realistas para Ordenes de taller de motos.
...
```text
intermedio/ejercicios/07-orden-taller-motos/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/07-orden-taller-motos/resoluciones/juan-perez/index.ts
```
