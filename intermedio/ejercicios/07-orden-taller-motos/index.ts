...
const guide: Exercise07Guide = {
  id: 7,
  title: "Ordenes de taller de motos",
  ...
  checklist: ["Modela el dominio de motos y mecanica de motos con tipos e interfaces claras.","Crea datos de prueba realistas para Ordenes de taller de motos.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa interface y type alias sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise07Guide): void {
