...
Vas a resolver un caso relacionado con animacion 3D: **Pipeline de animacion 3D**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de animacion 3D con tipos e interfaces claras.
2. Crea datos de prueba realistas para Pipeline de animacion 3D.
...
```text
intermedio/ejercicios/24-pipeline-animacion-3d/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/24-pipeline-animacion-3d/resoluciones/juan-perez/index.ts
```
