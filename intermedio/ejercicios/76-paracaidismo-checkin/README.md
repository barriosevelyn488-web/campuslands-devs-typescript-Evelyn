...
Vas a resolver un caso relacionado con paracaidismo: **Check-in de salto**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de paracaidismo con tipos e interfaces claras.
2. Crea datos de prueba realistas para Check-in de salto.
...
```text
intermedio/ejercicios/76-paracaidismo-checkin/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/76-paracaidismo-checkin/resoluciones/juan-perez/index.ts
```
