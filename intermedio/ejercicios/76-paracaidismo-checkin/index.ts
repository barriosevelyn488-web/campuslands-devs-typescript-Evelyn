...
const guide: Exercise76Guide = {
  id: 76,
  title: "Check-in de salto",
  ...
  checklist: ["Modela el dominio de paracaidismo con tipos e interfaces claras.","Crea datos de prueba realistas para Check-in de salto.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa arquitectura simple y DTO sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise76Guide): void {
