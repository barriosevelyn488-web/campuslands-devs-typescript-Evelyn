...
Vas a resolver un caso relacionado con musica: **Setlist de concierto**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de musica con tipos e interfaces claras.
2. Crea datos de prueba realistas para Setlist de concierto.
...
```text
intermedio/ejercicios/38-setlist-concierto/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/38-setlist-concierto/resoluciones/juan-perez/index.ts
```
