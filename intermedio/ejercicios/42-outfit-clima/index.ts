...
const guide: Exercise42Guide = {
  id: 42,
  title: "Outfit segun clima",
  difficulty: 'intermedio',
  topic: "ropa",
  focus: "fechas, estados, reportes y agrupacion de datos",
  concepts: ["clases","generics","encapsulamiento","servicios"] as const,
  checklist: ["Modela el dominio de ropa con tipos e interfaces claras.","Crea datos de prueba realistas para Outfit segun clima.","Implementa funciones separadas para validar, transformar y calcular resultados.","Usa clases y generics sin recurrir a any.","Muestra un resumen final que permita revisar si la solucion cumple el objetivo."] as const,
};

function printGuide(exercise: Exercise42Guide): void {
