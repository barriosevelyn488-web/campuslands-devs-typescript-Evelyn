...
Vas a resolver un caso relacionado con ropa: **Outfit segun clima**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Outfit segun clima.
...
```text
intermedio/ejercicios/42-outfit-clima/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/42-outfit-clima/resoluciones/juan-perez/index.ts
```
