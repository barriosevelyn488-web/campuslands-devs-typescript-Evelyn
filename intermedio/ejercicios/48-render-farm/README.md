...
Vas a resolver un caso relacionado con animacion 3D: **Render farm 3D**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Render farm 3D.
...
```text
intermedio/ejercicios/48-render-farm/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/48-render-farm/resoluciones/juan-perez/index.ts
```
