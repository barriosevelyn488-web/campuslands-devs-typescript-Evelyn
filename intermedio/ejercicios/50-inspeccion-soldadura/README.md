...
Vas a resolver un caso relacionado con soldadura: **Inspeccion visual soldadura**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de soldadura con tipos e interfaces claras.
2. Crea datos de prueba realistas para Inspeccion visual soldadura.
...
```text
intermedio/ejercicios/50-inspeccion-soldadura/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/50-inspeccion-soldadura/resoluciones/juan-perez/index.ts
```
