# 44. Rutas turisticas inteligentes
...
Vas a resolver un caso relacionado con turismo: **Rutas turisticas inteligentes**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de turismo con tipos e interfaces claras.
2. Crea datos de prueba realistas para Rutas turisticas inteligentes.
...
```text
intermedio/ejercicios/44-rutas-turisticas/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/44-rutas-turisticas/resoluciones/juan-perez/index.ts
```
