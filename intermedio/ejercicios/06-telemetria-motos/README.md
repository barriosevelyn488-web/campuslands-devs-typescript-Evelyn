...
Vas a resolver un caso relacionado con motos y mecanica de motos: **Telemetria de motos deportivas**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Telemetria de motos deportivas.
...
```text
intermedio/ejercicios/06-telemetria-motos/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/06-telemetria-motos/resoluciones/juan-perez/index.ts
```
