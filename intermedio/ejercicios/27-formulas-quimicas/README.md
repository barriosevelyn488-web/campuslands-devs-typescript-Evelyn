# 27. Validador de formulas quimicas
...
Vas a resolver un caso relacionado con formulas quimicas: **Validador de formulas quimicas**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Validador de formulas quimicas.
3. Implementa funciones separadas para validar, transformar y calcular resultados.
4. Usa reduce y Record sin recurrir a any.
...
```text
intermedio/ejercicios/27-formulas-quimicas/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/27-formulas-quimicas/resoluciones/juan-perez/index.ts
```
...
Conceptos recomendados: `reduce`, `Record`, `Map`, `agrupacion`.
