...
Vas a resolver un caso relacionado con futbol: **Mercado de fichajes futbol**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Mercado de fichajes futbol.
...
```text
intermedio/ejercicios/56-mercado-fichajes/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/56-mercado-fichajes/resoluciones/juan-perez/index.ts
```
