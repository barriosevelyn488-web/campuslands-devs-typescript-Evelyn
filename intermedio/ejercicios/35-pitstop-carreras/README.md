...
Vas a resolver un caso relacionado con carreras: **Estrategia de pit stop**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de carreras con tipos e interfaces claras.
2. Crea datos de prueba realistas para Estrategia de pit stop.
...
```text
intermedio/ejercicios/35-pitstop-carreras/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/35-pitstop-carreras/resoluciones/juan-perez/index.ts
```
