...
Vas a resolver un caso relacionado con turismo: **Lista turistica interactiva**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Lista turistica interactiva.
...
```text
intermedio/ejercicios/75-turismo-mapa-lista/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/75-turismo-mapa-lista/resoluciones/juan-perez/index.ts
```
