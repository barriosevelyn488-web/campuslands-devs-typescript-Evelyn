...
Vas a resolver un caso relacionado con paracaidismo: **Log avanzado de saltos**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Log avanzado de saltos.
...
```text
intermedio/ejercicios/45-log-saltos/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/45-log-saltos/resoluciones/juan-perez/index.ts
```
