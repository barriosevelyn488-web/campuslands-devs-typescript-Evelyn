...
Vas a resolver un caso relacionado con ciencia ficcion: **Terminal sci-fi**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Terminal sci-fi.
...
```text
intermedio/ejercicios/70-sci-fi-terminal/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/70-sci-fi-terminal/resoluciones/juan-perez/index.ts
```
