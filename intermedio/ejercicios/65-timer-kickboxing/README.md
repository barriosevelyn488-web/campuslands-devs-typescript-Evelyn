...
Vas a resolver un caso relacionado con kickboxing: **Timer de rounds kickboxing**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
2. Crea datos de prueba realistas para Timer de rounds kickboxing.
...
```text
intermedio/ejercicios/65-timer-kickboxing/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/65-timer-kickboxing/resoluciones/juan-perez/index.ts
```
