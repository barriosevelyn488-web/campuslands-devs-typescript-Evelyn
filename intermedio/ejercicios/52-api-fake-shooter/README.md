...
videojuegos shooters

## Contexto del problema

Vas a resolver un caso relacionado con videojuegos shooters: **Cliente API fake shooter**. La idea es practicar TypeScript como se usa en proyectos reales: primero entiendes los datos, luego defines tipos claros y finalmente implementas la logica.
...
1. Modela el dominio de videojuegos shooters con tipos e interfaces claras.
2. Crea datos de prueba realistas para Cliente API fake shooter.
...
```text
intermedio/ejercicios/52-api-fake-shooter/resoluciones/nombre-apellido/
```

Ejemplo valido:

```text
intermedio/ejercicios/52-api-fake-shooter/resoluciones/juan-perez/index.ts
```
